    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const result = await emailjs.sendForm(
                'service_d0xn6qc',      // Replace with your EmailJS Service ID
                'template_rnjwxti',     // Replace with your EmailJS Template ID
                formRef.current!,
                '-oY7ac0HtEF3r5nZW'       // Replace with your EmailJS Public Key
            );
                    ...
                    <motion.div className={styles.infoCard} variants={fadeInUp}>
                        ...
                        <div className={styles.contactItem}>
                            ...
                            <div className={styles.contactDetails}>
                                ...
                                <a href="mailto:info@vishdesignstudio.com" className={styles.contactValue}>
                                    info@vishdesignstudio.com
                                </a>
                                <a href="mailto:designstudio.vish@gmail.com" className={styles.contactValue} style={{ display: 'block', marginTop: '0.5rem', fontSize: '1.125rem' }}>
                ...
                >
                    ...
                    >
                        <div className={styles.modalContent}>
                            {formStatus === 'success' ? (
                                <>
                                    <div className={styles.modalIcon} style={{ background: '#d4edda' }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#155724" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                            <polyline points="20 6 9 17 4 12" />
                                        </svg>
                                    </div>
                                    <h3 className={styles.modalTitle}>Message Sent Successfully!</h3>
                                ...
                                <>
                                    <div className={styles.modalIcon} style={{ background: '#f8d7da' }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#721c24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                            <circle cx="12" cy="12" r="10" />
                                            <line x1="15" y1="9" x2="9" y2="15" />
                                            <line x1="9" y1="9" x2="15" y2="15" />
                                        </svg>
                                    </div>
                                    <h3 className={styles.modalTitle}>Oops! Something Went Wrong</h3>
                                    <p className={styles.modalText}>
                                        Failed to send message. Please try again or email us directly at info@vishdesignstudio.com
                                    </p>
                                </>
                            )}
                            <button
